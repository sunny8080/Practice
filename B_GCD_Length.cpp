...
int32_t main() {
    ...
    wt(t) {
        driii(a, b, c);
        // // gcd(x, y) => c length => gcd = 10^(c-1)
        // string x = "1" + string(a - c, '0') + string(c - 1, '0');
        // string y = "1" + string(b - c, '1') + string(c - 1, '0');
        // cout << x << sp << y << nl;


        cout<<(ll)pow(10ll, a-1)<<sp<<(ll)(pow(10ll, b-1) + pow(10ll, c-1))<<nl;
    }
